...
IF(LIBRAW_FOUND)
  ...
  IF(UNIX)
    EXECUTE_PROCESS(COMMAND ./find_demosaicing_gpl2.sh ${LIBRAW_LIBRARY} WORKING_DIRECTORY ${PROJECT_SOURCE_DIR} OUTPUT_VARIABLE _output OUTPUT_STRIP_TRAILING_WHITESPACE)
    IF(_output)
    ...
    ENDIF(_output)
    EXECUTE_PROCESS(COMMAND ./find_demosaicing_gpl3.sh ${LIBRAW_LIBRARY} WORKING_DIRECTORY ${PROJECT_SOURCE_DIR} OUTPUT_VARIABLE _output OUTPUT_STRIP_TRAILING_WHITESPACE)
    IF(_output)
