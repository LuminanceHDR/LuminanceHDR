...
void transform(InputIterator in1, InputIterator in1End, InputIterator in2, InputIterator in3,
               ...
               ConversionOperator convOp, size_t outputStepSize,
               InputIteratorTag, OutputIteratorTag)
{
    while ( in1 != in1End )
    {
        ...
        std::advance(out1, outputStepSize);
        std::advance(out2, outputStepSize);
        std::advance(out3, outputStepSize);
    }
}
...
#pragma omp parallel for
    for ( int idx = 0; idx < numElem; ++idx) {
        convOp(in1[idx], in2[idx], in3[idx],
               out1[idx*outputStepSize], out2[idx*outputStepSize], out3[idx*outputStepSize]);
    }
}
               ...
               ConversionOperator convOp, size_t outputStepSize)
{
    ...
    detail::transform(in1, in1End, in2, in3, out1, out2, out3, convOp, outputStepSize,
