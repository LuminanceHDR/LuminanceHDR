...
struct TonemapOperatorLischinski06
    : public TonemapOperatorRegister<lischinski, TonemapOperatorLischinski06> {
    void tonemapFrame(pfs::Frame &workingframe, TonemappingOptions *opts,
                      pfs::Progress &ph) {
        ph.setMaximum(100);
...
inline const TonemapOperatorCreatorMap &registry() {
    static TonemapOperatorCreatorMap reg = map_list_of
        ...
        (lischinski,  TonemapOperatorRegister<lischinski, TonemapOperatorLischinski06>::create);
    return reg;
}
