...
void FrameReaderFactory::registerFormat(const std::string& format,
                                        FrameReaderFactory::FrameReaderCreator creator)
{
    sm_registry.insert( FrameReaderCreatorMap::value_type(format, creator) );
}

size_t FrameReaderFactory::numRegisteredFormats()
{
