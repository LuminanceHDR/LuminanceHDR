...
int Fattal02Thread::counter = 0;

static QReadWriteLock lock;	

Fattal02Thread::Fattal02Thread(pfs::Frame *frame, int xorigsize, const tonemapping_options opts) : 
...
void Fattal02Thread::terminateRequested() {
	//TODO
	ph->terminate(true);
}
