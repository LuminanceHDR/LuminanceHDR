...
int Mantiuk06Thread::counter = 0;

static QReadWriteLock lock;	

Mantiuk06Thread::Mantiuk06Thread(pfs::Frame *frame, int xorigsize, const tonemapping_options opts) : 
...
Mantiuk06Thread::~Mantiuk06Thread() {
	delete ph;
}
...
void Mantiuk06Thread::terminateRequested() {
	//TODO
	ph->terminate(true);
}
