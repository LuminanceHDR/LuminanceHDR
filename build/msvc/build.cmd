...
SET EXIV2_COMMIT=3071

REM  sourceforge.net/p/libjpeg-turbo/code/
SET LIBJPEG_COMMIT=992
...
IF NOT EXIST %TEMP_DIR%\lpng170b16.zip (
    %CYGWIN_DIR%\bin\wget.exe -O %TEMP_DIR%/lpng170b16.zip http://sourceforge.net/projects/libpng/files/libpng17/1.7.0beta16/lp170b16.zip/download
)
IF NOT EXIST lp170b16 (
    %CYGWIN_DIR%\bin\unzip.exe -q %TEMP_DIR%/lpng170b16.zip
    pushd lp170b16
...
REM 
REM     pushd %L_BOOST_DIR%\boost_1_%BOOST_MINOR%_0
REM     bootstrap.bat
REM     popd
REM     
REM     pushd %L_BOOST_DIR%\boost_1_%BOOST_MINOR%_0
...
robocopy lp170b16 LuminanceHdrStuff\DEPs\include\libpng *.h /MIR >nul
robocopy lp170b16\%Configuration% LuminanceHdrStuff\DEPs\lib\libpng *.lib /MIR >nul
robocopy lp170b16\%Configuration% LuminanceHdrStuff\DEPs\bin\libpng *.dll /MIR >nul
...
IF EXIST LuminanceHdrStuff\qtpfsgui.build\%ConfigurationLuminance%\luminance-hdr.exe (
    IF EXIST LuminanceHdrStuff\qtpfsgui.build\%ConfigurationLuminance% (
        ...
        IF %Platform% EQU Win32 (
            robocopy %TEMP_DIR%\%RawPlatform% LuminanceHdrStuff\qtpfsgui.build\%ConfigurationLuminance% huginbase.dll huginvigraimpex.dll msvcp100.dll msvcr100.dll >nul
        )
